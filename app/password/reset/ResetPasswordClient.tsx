// app/password/reset/ResetPasswordClient.tsx
"use client";
        ...
        return (
            <div className="w-full max-w-[350px] border border-red-200 bg-red-50 dark:bg-red-900/10 dark:border-red-800 rounded-[8px] p-6 text-center">
                ...
                <button
                    ...
                    className="mt-4 text-[13px] text-blue-600 dark:text-blue-400 hover:underline cursor-pointer"
                >
                ...
                <div className="mb-3">
                    ...
                    <div className="relative">
                        ...
                        <button
                            ...
                            className="absolute right-3 top-1/2 -translate-y-1/2 text-[11px] text-gray-500 dark:text-gray-400 hover:text-gray-700 font-medium cursor-pointer"
                        >
