// app/business-cost/ServiceCalculator.tsx
"use client";
...
// ... Include your ServiceCard component here exactly as you had it ...
const ServiceCard = ({ item, isActive, onToggle }: { item: any; isActive: boolean; onToggle: () => void; }) => {
    return (
        <div
            role="button"
            tabIndex={0}
