...
export const metadata: Metadata = {
  title: "How It Works | Hiring Vetted Talent",
  description: "Learn how Yandu connects you with top-tier developers and designers. A seamless process from project pitch to final delivery.",
}
