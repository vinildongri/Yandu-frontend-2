...
export const metadata: Metadata = {
  title: "About Us | The Yandu Story",
  description: "Learn about Yandu, the premium freelance agency where engineering meets creativity. We build the future of web, mobile, and brand identity.",
}
