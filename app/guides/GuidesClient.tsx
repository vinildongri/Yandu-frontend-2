                ...
                <div className="bg-[#111318] rounded-[3rem] p-12 text-center text-white shadow-2xl relative overflow-hidden border border-slate-800">
                    <div className="relative z-10">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link href="mailto:vinilwork88@gmail.com" className="bg-blue-500 hover:bg-blue-600 px-10 py-4 rounded-full font-bold">
                                Contact Support
                            </Link>
                            <Link href="/contact" className="bg-emerald-600 hover:bg-emerald-500 px-10 py-4 rounded-full font-bold flex items-center gap-2 justify-center">
